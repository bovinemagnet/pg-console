...
**Diagnostics**::
All diagnostic tools including pipeline risk, TOAST bloat, index redundancy, XID wraparound monitoring, and metrics history (which stores all data in-memory by design).
