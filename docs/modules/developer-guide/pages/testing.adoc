...
* Metrics History (`/diagnostics/metrics-history`)
* Query Trends (`/diagnostics/query-trends`)
* Database Trends (`/diagnostics/database-trends`)
* Infrastructure Trends (`/diagnostics/infrastructure-trends`)
* Stopwatch (`/stopwatch`)
* Window Comparison (`/window-compare`)
