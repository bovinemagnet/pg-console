...
.Overview dashboard in dark mode
image::screenshot-overview-dark.png[Overview Dashboard,width=800]
...
.Slow queries dashboard in dark mode
image::screenshot-slow-queries-dark.png[Slow Queries Dashboard,width=800]
...
.Activity dashboard in dark mode
image::screenshot-activity-dark.png[Activity Dashboard,width=800]
...
.Locks dashboard in dark mode
image::screenshot-locks-dark.png[Locks Dashboard,width=800]
...
.Tables dashboard in dark mode
image::screenshot-tables-dark.png[Tables Dashboard,width=800]
...
.Databases dashboard in dark mode
image::screenshot-databases-dark.png[Databases Dashboard,width=800]
