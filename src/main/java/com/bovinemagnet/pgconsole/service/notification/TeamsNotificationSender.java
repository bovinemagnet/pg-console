...
public class TeamsNotificationSender extends AbstractNotificationSender {
    ...
    public boolean validateConfig(NotificationChannel channel) {
        ...
        return webhookUrl != null &&
               ...
               (webhookUrl.contains("webhook.office.com") ||
                webhookUrl.contains("outlook.office.com"));
    }

    private String buildAdaptiveCardPayload(NotificationChannel channel, TeamsConfig config, ActiveAlert alert) {
        String themeColour = config.getThemeColor() != null ?
            config.getThemeColor() : getSeverityColour(alert.getAlertSeverity()).replace("#", "");
        ...
        payload.append("{\"type\":\"TextBlock\",\"size\":\"Large\",\"weight\":\"Bolder\",\"text\":\"")
               .append(getSeverityEmoji(alert.getAlertSeverity())).append(" ")
        ...
        // Message
        payload.append("{\"type\":\"Container\",\"items\":[");
        payload.append("{\"type\":\"TextBlock\",\"text\":\"").append(escapeJson(alert.getAlertMessage()))
               .append("\",\"wrap\":true}");
        payload.append("]}");
    ...
    private String buildTestPayload(NotificationChannel channel, TeamsConfig config) {
        ...
        payload.append("{\"type\":\"TextBlock\",\"text\":\"Channel '").append(escapeJson(channel.getName()))
               .append("' is configured correctly!\",\"wrap\":true}");
        payload.append("]");
        payload.append("}");
        payload.append("}]");
        payload.append("}");
