...
public class SparklineService {
    ...
    /**
     * Generates a connections sparkline from system history.
     */
    public String getConnectionsSparkline(int hours, int width, int height) {
        List<SystemMetricsHistory> history = historyRepository.getSystemMetricsHistory(hours);
    ...
    /**
     * Generates an active queries sparkline from system history.
     */
    ...
    /**
     * Generates a blocked queries sparkline from system history.
     */
    ...
    /**
     * Generates a cache hit ratio sparkline from system history.
     */
    ...
    /**
     * Generates a query mean time sparkline from query history.
     */
    public String getQueryMeanTimeSparkline(String queryId, int hours, int width, int height) {
        List<QueryMetricsHistory> history = historyRepository.getQueryMetricsHistory(queryId, hours);
        List<Double> values = history.stream()
    ...
    /**
     * Generates a query calls sparkline from query history.
     */
