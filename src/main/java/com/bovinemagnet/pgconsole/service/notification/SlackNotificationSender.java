...
public class SlackNotificationSender extends AbstractNotificationSender {
    ...
    private String buildSimplePayload(NotificationChannel channel, SlackConfig config, ActiveAlert alert) {
        ...
        text.append(getSeverityEmoji(alert.getAlertSeverity()))
            .append(" *").append(escapeJson(alert.getAlertType())).append("*")
            .append(" [").append(alert.getAlertSeverity()).append("]\\n")
    ...
    private String buildBlockKitPayload(NotificationChannel channel, SlackConfig config, ActiveAlert alert) {
        ...
        // Fallback text
        payload.append("\"text\":\"").append(getSeverityEmoji(alert.getAlertSeverity()))
               .append(" ").append(escapeJson(alert.getAlertType())).append(": ")
        ...
        // Header block
        payload.append("{\"type\":\"header\",\"text\":{\"type\":\"plain_text\",\"text\":\"")
               .append(getSeverityEmoji(alert.getAlertSeverity())).append(" ")
               .append(escapeJson(alert.getAlertType())).append("\",\"emoji\":true}},");
        ...
        // Message section
        payload.append("{\"type\":\"section\",\"text\":{\"type\":\"mrkdwn\",\"text\":\"")
               .append(escapeJson(alert.getAlertMessage())).append("\"}},");
    ...
    private String buildTestPayload(NotificationChannel channel, SlackConfig config) {
        ...
        payload.append("\"text\":\"").append("✅ Test notification from PG Console - Channel '")
